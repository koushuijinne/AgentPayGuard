# Role D 指南：运营/演示与最终呈现

本指南为 Role D (运营/演示负责人) 提供完整的工作流程，从 Role C 的证据索引制作最终的 PPT、讲稿和演示素材。
...
3. **准备现场讲稿** - 时间标记（"第 30 秒点击代码"）+ 应对Q&A
...
| 阶段 | 输入 | 输出 |
|------|------|------|
| **输入** | Role C 的 for_judge.md + EVIDENCE_INDEX.md | - |
| **第 1 步** | 证据索引 | PPT 初稿 |
| **第 2 步** | 演示视频（来自 C） | 剪辑后的 1-3 分钟视频 + 10-30 秒高能版 |
| **第 3 步** | PPT + 视频 | 现场讲稿（含时间轴） |
| **最终** | 讲稿 + PPT + 视频 | 归档 + 最终检查清单 |
